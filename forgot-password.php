...
<head>
    <title>Forgotten Password | Project Crawler</title>
...
<body class="bodyDefault">
    ...
    <div class="container-fluid text-center">
        <h1 class="display-1">Forgotten Password</h1>
        <p class="lead">If you have forgotten your password, enter your email to send a reset link.</p>
